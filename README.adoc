:project-name: miq-RedHat-CloudForms
:project-repo: https://github.com/rhtconsulting/miq-RedHat-CloudForms
:project-zip: https://github.com/rhtconsulting/miq-RedHat-CloudForms/archive/master.zip
