:project-name: 
:project-repo: https://github.com/rhtconsulting/
:project-zip: https://github.com/rhtconsulting//archive/master.zip
...
----
PROJECT_NAME=""
PROJECT_ZIP="https://github.com/rhtconsulting//archive/master.zip"
cd /tmp
